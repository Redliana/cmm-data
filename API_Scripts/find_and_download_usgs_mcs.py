...
CMM_COMMODITIES = {
    ...
    "COBALT": {"keywords": ["COBALT"], "cmm_categories": ["Cobalt"]},
    "LITHIUM": {"keywords": ["LITHIUM"], "cmm_categories": ["Lithium"]},
    "GALLIUM": {"keywords": ["GALLIUM"], "cmm_categories": ["Gallium"]},
    "GRAPHITE": {"keywords": ["GRAPHITE"], "cmm_categories": ["Graphite"]},
    "NICKEL": {"keywords": ["NICKEL"], "cmm_categories": ["Nickel"]},
    "COPPER": {"keywords": ["COPPER"], "cmm_categories": ["Copper"]},
    "GERMANIUM": {"keywords": ["GERMANIUM"], "cmm_categories": ["Germanium"]},
    "MANGANESE": {"keywords": ["MANGANESE"], "cmm_categories": ["Manganese"]},
    "TITANIUM": {"keywords": ["TITANIUM"], "cmm_categories": ["Titanium"]},
    "TUNGSTEN": {"keywords": ["TUNGSTEN"], "cmm_categories": ["Tungsten"]},
    "PLATINUM": {
...
class USGSMCSAutoDownloader:
    ...
    def download_year(self, release_id: str, year: int) -> dict:
        ...
        for commodity_name, info in commodities.items():
            ...
            files = self.download_commodity_files(info["item_id"], commodity_name, year)
        ...
        ids_data = {
            commodity: {"item_id": info["item_id"], "cmm_categories": info["cmm_categories"]}
